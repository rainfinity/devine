...
import RainfinityDevineRainfinityDevineDevine from './rainfinity/devine/rainfinity.devine.devine'
...
export default { 
  ...
  RainfinityDevineRainfinityDevineDevine: load(RainfinityDevineRainfinityDevineDevine, 'rainfinity.devine.devine'),
